...
<body>
    ...
    <div id="timetable-container">
        <!-- Master Timetable will be displayed here -->
        <iframe id="master-timetable" src="master_timetable.php" style="width: 100%; height: 100vh; border: none;"></iframe>
    </div>
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                document.getElementById('master-timetable').contentWindow.location.reload();
            } else {
