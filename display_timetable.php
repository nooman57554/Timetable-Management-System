...
if ($role) {
    ...
    $sql = "SELECT schedule.*, subjects.subject_name, classes.class_name
        ...
        $sql = "SELECT schedule.*, subjects.subject_name, classes.class_name
                ...
                ORDER BY FIELD(day, 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'), FIELD(slot, '9AM - 10AM', '10AM - 11AM', '11AM - 12PM', '12PM - 1PM', '1PM - 2PM', '2PM - 3PM', '3PM - 4PM')";
}
