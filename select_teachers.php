    ...
    <script>
        $(document).ready(function() {
                            ...
                            response.subjects.forEach(function(subject) {
                                subjectAssignments += `
                                    <div>
                                        ...
                                        <input type="hidden" name="subjects[${subject.subject_id}]" value="${subject.no_hours_per_week}">
                                    </div>`;
                            });
            ...
            $('#assignment-form').submit(function(e) {
                ...
                var teacherAssignments = $(this).serializeArray();
                ...
                $.ajax({
                    url: 'generate_timetable.php',
                    type: 'POST',
                    data: data,
                    success: function(response) {
                        // Handle the response from generate_timetable.php
